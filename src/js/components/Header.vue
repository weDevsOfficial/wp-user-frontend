...
<template>
    <div class="wpuf-w-[calc(100%+40px)] wpuf-ml-[-20px] wpuf-px-[20px] wpuf-py-[15px] wpuf-bg-white wpuf-flex wpuf-justify-between wpuf-items-center wpuf-border-b wpuf-border-gray-100 wpuf-border-gray-100">
        <div class="wpuf-flex wpuf-justify-start wpuf-items-center">
            ...
            <span class="wpuf-ml-2 wpuf-inline-flex wpuf-items-center wpuf-rounded-full wpuf-bg-green-100 wpuf-px-2 wpuf-py-1 wpuf-text-xs wpuf-font-medium wpuf-text-green-700 wpuf-ring-1 wpuf-ring-inset wpuf-ring-green-600/20">v{{ wpuf_admin_script.version }}</span>
            <a
                v-if="!wpuf_admin_script.isProActive"
                :href="wpuf_admin_script.upgradeUrl"
                target="_blank"
        ...
        <div class="wpuf-flex wpuf-justify-end wpuf-items-center wpuf-w-2/4">
            ...
            <a
                :href="wpuf_admin_script.supportUrl"
                target="_blank"
