...
<template>
    ...
    <div id="accordion-expiration" aria-labelledby="accordion-expiration-heading">
        <div class="wpuf-p-4 wpuf-border wpuf-border-gray-200">
            <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                <label for="post-expiration" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
            ...
            <div v-if="isPostExpirationEnabled">
                <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                    <label for="post-expiration-value" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
                    ...
                    <div class="wpuf-flex">
                        <input
                            ...
                            class="wpuf-block wpuf-w-full wpuf-rounded-md wpuf-border-0 wpuf-py-1.5 wpuf-text-gray-900 wpuf-shadow-sm wpuf-ring-1 wpuf-ring-inset wpuf-ring-gray-300 placeholder:wpuf-text-gray-400 focus:wpuf-ring-2 focus:wpuf-ring-inset focus:wpuf-ring-indigo-600 wpuf-max-w-xs wpuf-text-sm wpuf-leading-6">
                        <select>
                            <option
                ...
                <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                    <label for="post-status" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
                ...
                <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                    <label for="expiration-mail" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
            ...
            <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                <label for="post-rollback" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
