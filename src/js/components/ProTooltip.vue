...
<template>
    <div
        ...
        class="wpuf-absolute wpuf-bg-black wpuf-z-50 wpuf-card wpuf-w-96 wpuf-shadow-xl wpuf-text-white wpuf-w-max wpuf-p-8 wpuf-items-center">
        <h3 class="wpuf-text-xl wpuf-text-white">{{ __( 'Available in Pro. Also enjoy:', 'wp-user-frontend' ) }}</h3>
        <ul class="wpuf-self-start">
            <li v-for="offer in offers" :key="offer" class="wpuf-mt-4 wpuf-flex wpuf-text-sm wpuf-items-center">
        ...
        <a
            ...
            <span
                class="pro-icon icon-white wpuf-ml-2">
        ...
        <i
            :class="caretClassList"
            class="wpuf-absolute wpuf-bg-black wpuf-w-[24px] wpuf-h-[24px] wpuf-overflow-hidden wpuf-ml-[-24px] wpuf-rotate-45"></i>
    </div>
</template>
