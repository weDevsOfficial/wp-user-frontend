...
class WPUF_Admin_Settings {
    ...
    public function admin_menu() {
        ...
        // Translation issue: DO NOT translate menu_title.
        // We are using a dynamic hook depending on the menu title. If the title got translated,
        // the hook don't work for some languages(Español etc.) and shows blank post form
