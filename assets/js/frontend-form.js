;(function($, window) {
    ...
    window.WP_User_Frontend = {
        ...
        init: function() {
            ...
            // remove jQuery inherit validation
            $('.wpuf-form input[type="submit"]').attr( 'formnovalidate', 'formnovalidate' );
        ...
        isValidEmail: function( email ) {
            ...
            $(email.split(',')).each(function(i, elm) {
                res = res && pattern.test(elm.trim());
            });
