    ...
    <div id="accordion-access" aria-labelledby="accordion-access-heading">
        <div class="wpuf-p-4 wpuf-border wpuf-border-gray-200">
            <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                <label for="is-plan-private" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
            ...
            <div class="wpuf-grid wpuf-grid-cols-3 wpuf-items-start wpuf-gap-4 wpuf-pb-4">
                <label for="slug" class="wpuf-block wpuf-text-sm wpuf-font-medium wpuf-leading-6 wpuf-text-gray-900 wpuf-pt-1.5">
