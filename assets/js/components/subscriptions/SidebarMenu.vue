...
<template>
    ...
    :class="subscriptionStore.isUnsavedPopupOpen ? 'wpuf-blur' : ''">
        <div class="wpuf-flex wpuf-flex-col wpuf-min-h-screen wpuf-pr-[48px]">
            <div class="wpuf-flex wpuf-items-center wpuf-justify-between wpuf-mb-[40px] wpuf-leading-none">
            ...
            <ul class="wpuf-space-y-2 wpuf-text-lg">
                <li
                    ...
                    <span
                        ...
                        class="wpuf-text-sm wpuf-w-fit wpuf-px-2.5 wpuf-py-1 wpuf-shadow-sm wpuf-rounded-full wpuf-ring-1 wpuf-w-max wpuf-h-max">
                        {{ subscriptionStore.allCount.all }}
                    </span>
                </li>
                <li
                    @click="$emit('checkIsDirty', 'publish')"
