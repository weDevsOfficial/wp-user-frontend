;(function($, window) {
    ...
    // check Dokan unique shop URL
    $(function($) {
        $('input[name="dokan_store_name"]').on('focusout', function() {
        ...
        $('input[name="shopurl"]').keydown(function(e) {
            var text = $(this).val();
        ...
        $('input[name="shopurl"]').keyup(function(e) {
            $('#url-alart').text( $(this).val() );
        });

        $('input[name="shopurl"]').on('focusout', function() {
            var self = $(this),
            data = {
                action : 'shop_url',
                url_slug : self.val(),
