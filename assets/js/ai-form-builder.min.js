...
• Get information: "What fields are required?"`},async handleSendMessage(){var o;if(!this.userInput.trim()||this.isFormUpdating)return;const t=this.userInput.trim();this.userInput="",!this.conversationState.form_created&&this.chatMessages.length===0&&this.initializeConversationState(t);const e=this.shouldMakeAPICall(t);this.chatMessages.push({type:"user",content:t,timestamp:new Date().toISOString()}),e&&(this.formFields.length>0?this.isFormUpdating=!0:this.isWaitingForAI=!0);const r={type:"ai",content:'<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: inline-block;"><path d="M16 12C17.1046 12 18 11.1046 18 10C18 8.89543 17.1046 8 16 8C14.8954 8 14 8.89543 14 10C14 11.1046 14.8954 12 16 12Z" fill="#6EE7B7"/><path d="M10 12C11.1046 12 12 11.1046 12 10C12 8.89543 11.1046 8 10 8C8.89543 8 8 8.89543 8 10C8 11.1046 8.89543 12 10 12Z" fill="#34D399"/><path d="M6 10C6 11.1046 5.10457 12 4 12C2.89543 12 2 11.1046 2 10C2 8.89543 2.89543 8 4 8C5.10457 8 6 8.89543 6 10Z" fill="#059669"/></svg>',showButtons:!1,isProcessing:!0,timestamp:new Date().toISOString()};this.chatMessages.push(r),this.scrollToBottom();try{let a;e?a=await this.callChatAPI(t):a={success:!0,message:this.generatePredefinedResponse(t),action:"info",form_data:null};const i=this.chatMessages.findIndex(n=>n.isProcessing);if(i!==-1&&this.chatMessages.splice(i,1),a.success){const n=a.form_data||a.data,s=n&&(n.wpuf_fields||n.modification_type==="add_field"),l=this.isInformationalQuery(t);let c="";if(l&&!s)a.message||(c="I can provide information about the form fields. Please be specific about what you'd like to know.");else if(s){const m=JSON.stringify(this.formFields),E=n.wpuf_fields?this.convertFieldsToPreview(n.wpuf_fields):this.formFields,j=JSON.stringify(E);m!==j?c="Form has been updated successfully.":c="The form already has those fields configured."}else c=a.message||"I can help you with form-related tasks. Try asking me to add, remove, or modify form fields.";const f=a.message||c,w={type:"ai",content:f,showButtons:this.shouldShowButtons(a,f),hasCheckpoint:!1,checkpointSaved:!1,response_data:a,timestamp:new Date().toISOString()};if(this.chatMessages.push(w),w.status&&this.$nextTick(()=>{this.showStatus(this.chatMessages.length-1)}),this.updateConversationState(t,w),n&&n.wpuf_fields){this.previousFormFields=JSON.parse(JSON.stringify(this.formFields));const m=this.formDescription,E=this.convertFieldsToPreview(n.wpuf_fields);this.pendingChanges={type:"form_update",fields:E,formTitle:n.form_title||this.formTitle,formDescription:n.form_description||this.formDescription,previousDescription:m,originalResponse:n},this.formFields=E,n.form_description&&(this.formDescription=n.form_description),this.isFormUpdating=!1,this.isWaitingForAI=!1}else if(a.data&&a.data.modification_type==="add_field"&&a.data.changes&&a.data.changes.field){this.previousFormFields=JSON.parse(JSON.stringify(this.formFields));const m=a.data.changes.field,E={id:m.id||`field_${this.formFields.length+1}`,type:m.type||"text_field",label:m.label||"New Field",name:m.name||((o=m.label)==null?void 0:o.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""))||"new_field",required:m.required||!1,placeholder:m.placeholder||"",help_text:m.help||"",options:m.options||[],default:m.default||""};this.pendingChanges={type:"add_field",field:E,originalResponse:a.data},this.formFields.push(E),this.isFormUpdating=!1,this.isWaitingForAI=!1}else this.isFormUpdating=!1,this.isWaitingForAI=!1}else{const n={type:"ai",content:a.message||"Sorry, I could not process your request. Please try again.",showButtons:!1,isError:!0,timestamp:new Date().toISOString()};this.chatMessages.push(n),n.status&&this.$nextTick(()=>{this.showStatus(this.chatMessages.length-1)}),this.isFormUpdating=!1,this.isWaitingForAI=!1}}catch(a){const i=this.chatMessages.findIndex(s=>s.isProcessing);i!==-1&&this.chatMessages.splice(i,1),this.isFormUpdating=!1,this.isWaitingForAI=!1;const n={type:"ai",content:a.message||"Sorry, there was an error processing your request. Please try again.",showButtons:!1,isError:!0,timestamp:new Date().toISOString()};this.chatMessages.push(n),n.status&&this.$nextTick(()=>{this.showStatus(this.chatMessages.length-1)})}this.scrollToBottom()},async callChatAPI(t){const e=window.wpufAIFormBuilder||{},r=e.rest_url||window.location.origin+"/wp-json/",o=e.nonce||"",a={session_id:this.sessionId,conversation_state:this.conversationState,current_form:{form_title:this.formTitle,form_description:this.formDescription,wpuf_fields:this.formFields.map((c,f)=>{if(c.input_type&&c.template&&c.wpuf_cond)return c;const w=c.type||"text_field";return{id:c.id||`field_${f+1}`,type:w,input_type:this.mapToInputType(w),template:w,required:c.required===!0||c.required==="yes"?"yes":"no",label:c.label||"Field",name:c.name||(c.label?c.label.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""):`field_${f+1}`),meta_key:c.meta_key||"",is_meta:this.shouldBeMeta(c.name||c.label)?"yes":"no",help:c.help_text||c.help||"",css:c.css||"",placeholder:c.placeholder||"",default:c.default||"",size:c.size||"40",width:c.width||"large",options:c.options||{},wpuf_cond:c.wpuf_cond||{condition_status:"no",cond_field:[],cond_operator:["="],cond_option:["- Select -"],cond_logic:"all"},wpuf_visibility:c.wpuf_visibility||{selected:"everyone",choices:[]}}}),settings:this.formSettings||{}},chat_history:this.chatMessages.filter(c=>!c.isProcessing&&!c.isError&&c.type).slice(-8).map(c=>({type:c.type,content:c.content,timestamp:c.timestamp}))},i="wpuf/v1/ai-form-builder/generate",n={prompt:t,session_id:this.sessionId,conversation_context:a,form_type:e.formType||"post",provider:e.provider||"google",language:this.selectedLanguage||"English"},s=await fetch(r+i,{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":o},body:JSON.stringify(n)});if(!s.ok){const c=await s.json().catch(()=>({}));throw new Error(c.message||s.statusText)}return await s.json()},scrollToBottom(){this.$nextTick(()=>{this.$refs.chatContainer&&(this.$refs.chatContainer.scrollTop=this.$refs.chatContainer.scrollHeight)})},async handleApply(){this.isApplying=!0;try{const t=window.wpufAIFormBuilder||{},e=t.rest_url||window.location.origin+"/wp-json/",r=t.nonce||"",o={form_title:this.formTitle||"AI Generated Form",form_description:this.formDescription||"Form created with AI assistance",wpuf_fields:this.formFields.map((n,s)=>{if(n.input_type&&n.template&&n.wpuf_cond)return n;const l=n.type||"text_field";return{id:n.id||`field_${s+1}`,type:l,input_type:this.mapToInputType(l),template:l,required:n.required===!0||n.required==="yes"?"yes":"no",label:n.label||"New Field",name:n.name||(n.label?n.label.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,""):`field_${s+1}`),meta_key:n.meta_key||"",is_meta:this.shouldBeMeta(n.name||n.label)?"yes":"no",help:n.help_text||n.help||"",css:n.css||"",placeholder:n.placeholder||"",default:n.default||"",size:n.size||"40",width:n.width||"large",options:n.options||[],wpuf_cond:n.wpuf_cond||{condition_status:"no",cond_field:[],cond_operator:["="],cond_option:["- Select -"],cond_logic:"all"},wpuf_visibility:n.wpuf_visibility||{selected:"everyone",choices:[]}}}),form_settings:this.formSettings||{submit_text:"Submit",success_message:"Form submitted successfully!",form_template:"default"}},a=await fetch(e+"wpuf/v1/ai-form-builder/create-form",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":r},body:JSON.stringify({form_data:o})});if(!a.ok){const n=await a.json().catch(()=>({}));throw new Error(n.message||a.statusText)}const i=await a.json();this.$emit("form-applied",{form_id:i.form_id,edit_url:i.edit_url})}catch(t){t.name==="TypeError"&&t.message.includes("fetch")?alert("Network error: Please check your connection and try again."):t.response&&t.response.status===413?alert("Form is too complex. Please simplify and try again."):alert("An error occurred while applying the form. Please try again.");const e={type:"ai",content:`Error applying form: ${t.message}. Please try again.`,showButtons:!1,isError:!0,timestamp:new Date().toISOString()};this.chatMessages.push(e),e.status&&this.$nextTick(()=>{this.showStatus(this.chatMessages.length-1)}),this.scrollToBottom()}finally{this.isApplying=!1,this.isFormUpdating=!1,this.isWaitingForAI=!1}},handleReject(){this.pendingChanges&&this.previousFormFields&&(this.formFields=JSON.parse(JSON.stringify(this.previousFormFields)),this.pendingChanges.type==="form_update"&&this.pendingChanges.previousDescription!==void 0&&(this.formDescription=this.pendingChanges.previousDescription),this.pendingChanges=null,this.previousFormFields=null),this.hideLastMessageButtons()},handleAccept(){var t,e;this.pendingChanges&&(this.pendingChanges.type==="form_update"?(this.pendingChanges.formTitle&&this.pendingChanges.formTitle!==this.formTitle&&this.$emit("title-updated",this.pendingChanges.formTitle),this.$emit("form-updated",{wpuf_fields:((t=this.pendingChanges.originalResponse)==null?void 0:t.wpuf_fields)||this.formFields,form_title:this.pendingChanges.formTitle||this.formTitle,form_description:this.pendingChanges.formDescription||this.formDescription})):this.$emit("form-updated",{wpuf_fields:this.formFields,form_title:this.formTitle,form_description:this.formDescription}));for(let r=this.chatMessages.length-1;r>=0;r--)if(this.chatMessages[r].showButtons){this.chatMessages[r].showButtons=!1;const o={formFields:this.pendingChanges&&this.pendingChanges.originalResponse&&this.pendingChanges.originalResponse.wpuf_fields?JSON.parse(JSON.stringify(this.pendingChanges.originalResponse.wpuf_fields)):JSON.parse(JSON.stringify(this.formFields)),formTitle:this.localFormTitle,formDescription:this.formDescription,formSettings:JSON.parse(JSON.stringify(this.formSettings)),timestamp:Date.now(),messageContent:((e=this.chatMessages[r])==null?void 0:e.content)||""};this.checkpoints.set(r,o),this.chatMessages[r].hasCheckpoint=!0,this.chatMessages[r].checkpointSaved=!0,this.chatMessages[r].acceptedStatus="✓ Changes accepted & checkpoint saved",this.pendingChanges=null,this.previousFormFields=null;break}},shouldShowButtons(t,e){var s,l,c,f;if(!t||!t.success||t.error||e.includes("Processing")||e.includes("Loading")||e.includes("Perfect! I've created")||e.includes("Successfully created the form")||this.chatMessages.length===0)return!1;const r=["here are some suggestions","you can try","for example","available options include","wpuf supports","you might want to","consider using","alternatively","note that","please note","keep in mind","remember that","tip:","helpful tip","pro tip","suggestion:","recommendations","best practices","you can also","if you need","to learn more","for more information","documentation","help","guide","tutorial","how to","instructions"],o=e.toLowerCase();if(r.some(w=>o.includes(w))||["understood","got it","okay","sure","no problem","will do","of course","absolutely","certainly"].some(w=>o.includes(w))&&o.length<100)return!1;if((t.form_data||t.data)&&(((s=t.form_data)==null?void 0:s.wpuf_fields)||((l=t.form_data)==null?void 0:l.fields)||((c=t.data)==null?void 0:c.modification_type)||((f=t.data)==null?void 0:f.changes)))return!0;const i=this.chatMessages.length>1,n=o.includes("added")||o.includes("removed")||o.includes("changed")||o.includes("updated")||o.includes("modified")||o.includes("converted")||o.includes("replaced")||o.includes("field")||o.includes("form")||o.includes("button")||o.includes("title")||o.includes("description");return i&&n},hideLastMessageButtons(){for(let t=this.chatMessages.length-1;t>=0;t--)if(this.chatMessages[t].showButtons){this.chatMessages[t].showButtons=!1;break}},mapToInputType(t){return{text_field:"text",email_address:"email",website_url:"url",numeric_text_field:"number",phone_field:"tel",textarea_field:"textarea",dropdown_field:"select",radio_field:"radio",checkbox_field:"checkbox",multiple_select:"multiselect",file_upload:"file_upload",date_field:"date",time_field:"time",address_field:"address_field",country_list_field:"select",toc:"checkbox",google_map:"google_map",ratings:"ratings"}[t]||"text"},shouldBeMeta(t){return!["title","content","excerpt","author","category","tags"].includes(t==null?void 0:t.toLowerCase())},handleRegenerate(){this.showRegenerateModal=!0},confirmRegenerate(){this.showRegenerateModal=!1,this.chatMessages=[],this.formFields=[],this.previousFormFields=[],this.pendingChanges=null,this.formDescription="",this.userInput="",this.checkpoints.clear(),this.conversationState={original_prompt:"",form_created:!1,modifications_count:0,context_history:[],is_predefined_template:!1,template_modified:!1,original_form_hash:null},this.sessionId=this.generateSessionId(),this.$emit("regenerate-form")},handleEditInBuilder(){if(this.checkpoints.clear(),!((window.wpufAIFormBuilder||{}).isProActive||!1)&&this.checkForProFields()){this.showProModal();return}const r=this.formFields.map(o=>({...o,required:o.required==="yes"||o.required===!0?"yes":"no"}));this.$emit("edit-in-builder",{formId:this.formId,formFields:r})},handleEditWithBuilder(){if(!((window.wpufAIFormBuilder||{}).isProActive||!1)&&this.checkForProFields()){this.showProModal();return}const r=this.formFields.map(o=>({...o,required:o.required==="yes"||o.required===!0?"yes":"no"}));this.$emit("edit-with-builder",{formId:this.formId,formFields:r})},checkForProFields(){const t=["date_field","time_field","datetime_field","numeric_text_field","numeric_field","phone_field","phone_number","address_field","country_list_field","country_list","google_map","multiple_select","multi_select","checkbox_grid","multiple_choice_grid","file_upload","audio_upload","video_upload","pricing_radio","pricing_checkbox","pricing_dropdown","pricing_multiselect","cart_total","ratings","rating","linear_scale","qr_code","embed","shortcode","action_hook","toc","terms_conditions","step_start","multistep","repeat_field","repeater","really_simple_captcha","math_captcha"],e=["text","text_field","email","email_address","url","website_url","textarea","textarea_field","dropdown","dropdown_field","select","checkbox","checkbox_field","radio","radio_field","hidden","hidden_field","html","section_break","post_title","post_content","post_excerpt","post_tags","taxonomy","category","featured_image","image_upload","recaptcha","recaptcha_v2","recaptcha_v3","cloudflare_turnstile","user_login","user_email","user_url","first_name","last_name","nickname","display_name","user_bio","biography","user_avatar","profile_photo","password","facebook_url","twitter_url","instagram_url","linkedin_url","column_field","custom_html","custom_hidden_field"],r=this.formFields.filter(o=>{const a=(o.type||"").toLowerCase(),i=(o.input_type||"").toLowerCase(),n=(o.template||"").toLowerCase();return e.some(l=>{const c=l.toLowerCase();return a===c||i===c||n===c})?!1:t.some(l=>{const c=l.toLowerCase();return a===c||i===c||n===c})});return r.length>0?r:null},showProModal(){const t=this.checkForProFields();if(!t)return;const e={date_field:"Date Picker",time_field:"Time Picker",datetime_field:"Date & Time",numeric_text_field:"Numeric Text",numeric_field:"Numeric Text",phone_field:"Phone Number",phone_number:"Phone Number",phone:"Phone Number",address_field:"Address",address:"Address",country_list_field:"Country List",country_list:"Country List",google_map:"Google Map",map:"Google Map",multiple_select:"Multi Select",multi_select:"Multi Select",checkbox_grid:"Checkbox Grid",multiple_choice_grid:"Multiple Choice Grid",file_upload:"File Upload",file:"File Upload",audio_upload:"Audio Upload",audio:"Audio Upload",video_upload:"Video Upload",video:"Video Upload",pricing_radio:"Pricing Radio",pricing_checkbox:"Pricing Checkbox",pricing_dropdown:"Pricing Dropdown",pricing_multiselect:"Pricing Multi Select",cart_total:"Cart Total",ratings:"Ratings",rating:"Ratings",linear_scale:"Linear Scale",qr_code:"QR Code",embed:"Embed",shortcode:"Shortcode",action_hook:"Action Hook",toc:"Terms & Conditions",terms_conditions:"Terms & Conditions",column_field:"Column Field",column:"Column Field",step_start:"Multi-Step Start",multistep:"Multi-Step Start",repeat_field:"Repeat Field",repeater:"Repeat Field",really_simple_captcha:"Really Simple Captcha",captcha:"Captcha",recaptcha:"reCAPTCHA",recaptcha_v2:"reCAPTCHA",recaptcha_v3:"reCAPTCHA v3"},r=l=>l.type||l.input_type||l.template||"Unknown Field",a=[...new Set(t.map(l=>r(l)))].slice(0,4).map(l=>{const c=l.toLowerCase();return{fieldKey:c,label:e[c]||e[l]||l}}),i=document.createElement("div");if(i.className="wpuf-pro-modal-overlay",i.innerHTML=`
                <div class="wpuf-pro-modal">
                    ...
                    <div class="wpuf-pro-fields-list">
                        ${a.map(l=>{const c=l.fieldKey||l,f=l.label||l,w=this.getProFieldIcon(c);return`
            ...
            `,document.body.appendChild(i),!document.getElementById("wpuf-pro-modal-styles")){const l=document.createElement("style");l.id="wpuf-pro-modal-styles",l.textContent=`
