    ...
    return (
        <div { ...blockProps }>
            <InspectorControls>
                ...
                >
                    <div style={ { marginBottom: '16px' } }>
                        <label
                            ...
                            style={ { display: 'block', marginBottom: '8px' } }
                        >
                            { __( 'Columns (Desktop)', 'wp-user-frontend' ) }
                        </label>
                        <ButtonGroup>
                            { [ 1, 2, 3, 4 ].map( ( num ) => (
                                <Button
                                    ...
                                    onClick={ () => setAttributes( { columns: num } ) }
                                >
                                    { num }
                                </Button>
                            ) ) }
                        ...
                        <p className="components-base-control__help">
                            { __( 'Mobile: 1 col → Tablet: 2 cols → Desktop: selected', 'wp-user-frontend' ) }
                        </p>
                    </div>
                ...
                <PanelBody
                    title={ __( 'Button', 'wp-user-frontend' ) }
                    initialOpen={ false }
                >
                    <div style={ { marginBottom: '16px' } }>
                        <label
