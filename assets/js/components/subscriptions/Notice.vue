...
const classes = {
    success: 'wpuf-text-green-500 wpuf-bg-green-100 dark:wpuf-bg-green-800 dark:wpuf-text-green-200',
    danger: 'wpuf-text-red-500 wpuf-bg-red-100 dark:wpuf-bg-red-800 dark:wpuf-text-red-200',
};
...
<template>
    <div
        ...
        <button @click="noticeStore.display = false" type="button" class="ms-auto wpuf--mx-1.5 wpuf--my-1.5 wpuf-bg-white wpuf-text-gray-400 hover:wpuf-text-gray-900 wpuf-rounded-lg focus:wpuf-ring-2 focus:wpuf-ring-gray-300 wpuf-p-1.5 hover:wpuf-bg-gray-100 wpuf-inline-flex wpuf-items-center wpuf-justify-center wpuf-h-8 wpuf-w-8 dark:wpuf-text-gray-500 dark:hover:wpuf-text-white dark:wpuf-bg-gray-800 dark:hover:wpuf-bg-gray-700" data-dismiss-target="#toast-success" aria-label="Close">
