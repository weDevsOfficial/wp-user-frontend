	...
	<div class="container">
		<div class="intro">
			<div class="header">
				...
				<div class="logo">
					<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/wpuf-logo.png" alt="WP User Frontend Pro">
				</div>
			</div>
			<div class="video-block" id="wpuf-welcome-prompt">
				<a href="#" class="play-video learn-more" title="Watch how to create your first form" data-tube="NJvjy9WFyAM">
					<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/welcome-video.png" alt="Watch how to create your first form" class="video-thumbnail">
				</a>
		...
		<div class="features-section">
			...
			<div class="section">
				<div class="features-block">
					<h2><img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/frontend-posting.png" alt="Frontend Posting"> Frontend Posting</h2>

					<div class="features-list">
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Form-Builder.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Support.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Post-Taxonomies.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Guest-Posting.svg">
							<h5>Guest Posting</h5>
				...
				<div class="features-block">
					<h2><img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Profile-Builder.png" alt="Frontend Posting"> Registration &amp; Profile Builder</h2>

					<div class="features-list">
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Registration-form.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Profile-Builder.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/My-Account.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Create-Database.svg">
							<h5>Login Page</h5>
				...
				<div class="features-block">
					<h2><img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Subscriptions.png" alt="Subscriptions"> Subscriptions</h2>

					<div class="features-list">
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/User.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/pay-per-post.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Content-Locking.svg">
						...
						<div class="feature-block">
							<img src="<?php echo esc_attr( WPUF_ASSET_URI ); ?>/images/welcome/Subscription-Signup.svg">
