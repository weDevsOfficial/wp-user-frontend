...
$plugins     = $this->get_pending_plugins();
$can_install = current_user_can( 'install_plugins' );
$errors      = get_option( \WeDevs\Wpuf\Admin\Onboarding::PLUGIN_ERRORS_OPTION, [] );
...
<form method="post">
                ...
                <?php if ( $can_install ) : ?>
                    <label class="wpuf-onboarding-card is-selected">
                        ...
                        <?php if ( ! empty( $plugin['logo'] ) ) : ?>
                            <img class="wpuf-onboarding-logo" src="<?php echo esc_url( WPUF_ASSET_URI . '/images/' . $plugin['logo'] ); ?>" alt="" />
                        <?php endif; ?>
    ...
    <?php $this->action_bar( [ 'next_label' => __( 'Install &amp; Continue', 'wp-user-frontend' ), 'show_skip' => true ] ); ?>
</form>
