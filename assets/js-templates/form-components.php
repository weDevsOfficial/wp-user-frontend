            ...
            <div
                ...
                <div v-if="!(is_full_width(field.template) || is_pro_preview(field.template))" class="wpuf-w-1/4 wpuf-flex wpuf-items-center">
                    <label
                        ...
                        <template v-if="field.template === 'twitter_url' && field.show_icon === 'yes'">
                            <svg class="wpuf-twitter-svg wpuf-inline wpuf-mr-2" width="20" height="20" viewBox="0 0 24 24" fill="#1da1f2" xmlns="http://www.w3.org/2000/svg">
