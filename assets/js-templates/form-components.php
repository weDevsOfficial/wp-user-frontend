        ...
        >
            <div v-if="!is_full_width(field.template)" class="wpuf-label">
                ...
                <span v-if="field.template === 'linkedin_url' && field.show_icon === 'yes'" class="wpuf-social-label-icon wpuf-inline-flex wpuf-items-center wpuf-ml-2">
                    <svg class="wpuf-linkedin-svg" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn" role="img">
                        <path d="M5.83398 7.0625V13.5417M5.83398 7.0625C6.75443 7.0625 7.50065 6.31628 7.50065 5.39583C7.50065 4.47538 6.75443 3.72917 5.83398 3.72917C4.91353 3.72917 4.16732 4.47538 4.16732 5.39583C4.16732 6.31628 4.91353 7.0625 5.83398 7.0625ZM11.0423 13.5417V10.3958C11.0423 8.88542 11.884 8.02083 13.334 8.02083C14.1882 8.02083 14.5215 8.45833 14.7923 8.89583V7.91667H15.834V13.5417M2.08398 9.9987C2.08398 6.26675 2.08398 4.40077 3.24335 3.2414C4.40273 2.08203 6.2687 2.08203 10.0007 2.08203C13.7326 2.08203 15.5986 2.08203 16.758 3.2414C17.9173 4.40077 17.9173 6.26675 17.9173 9.9987C17.9173 13.7306 17.9173 15.5966 16.758 16.756C15.5986 17.9154 13.7326 17.9154 10.0007 17.9154C6.2687 17.9154 4.40273 17.9154 3.24335 16.756C2.08398 15.5966 2.08398 13.7306 2.08398 9.9987Z" stroke="#079669" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </span>
                <span v-if="field.template === 'instagram_url' && field.show_icon === 'yes'" class="wpuf-social-label-icon wpuf-inline-flex wpuf-items-center wpuf-ml-2">
                    <svg class="wpuf-instagram-svg" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Instagram" role="img">
                        <path d="M13.2296 10.0001C13.2296 11.7873 11.787 13.2298 9.99983 13.2298C8.21266 13.2298 6.77011 11.7873 6.77011 10.0001C6.77011 8.21294 8.21266 6.77039 9.99983 6.77039C11.787 6.77039 13.2296 8.21294 13.2296 10.0001Z" stroke="#079669" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M14.5833 5.41667H14.5917M2.08398 9.9987C2.08398 6.26675 2.08398 4.40077 3.24335 3.2414C4.40273 2.08203 6.2687 2.08203 10.0007 2.08203C13.7326 2.08203 15.5986 2.08203 16.758 3.2414C17.9173 4.40077 17.9173 6.26675 17.9173 9.9987C17.9173 13.7306 17.9173 15.5966 16.758 16.756C15.5986 17.9154 13.7326 17.9154 10.0007 17.9154C6.2687 17.9154 4.40273 17.9154 3.24335 16.756C2.08398 15.5966 2.08398 13.7306 2.08398 9.9987Z" stroke="#079669" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </span>
            </div>
