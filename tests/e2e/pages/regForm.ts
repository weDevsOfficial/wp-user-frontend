...
export class RegFormPage extends Base {
    ...
    async completeWcfmMemberRegistrationFrontend() {
        ...
        await this.page.waitForLoadState('domcontentloaded', { timeout: 10000 });
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.descriptionField, VendorRegistrationForm.description);
        ...
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.facebookField, VendorRegistrationForm.wcfmMemberFacebook = `www.facebook.com/${faker.word.words(1)}`);
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.twitterField, VendorRegistrationForm.wcfmMemberTwitter = `www.x.com/${faker.word.words(1)}`);
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.googleField, VendorRegistrationForm.wcfmMemberGoogle = `www.google.com/${faker.word.words(1)}`);
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.linkedinField, VendorRegistrationForm.wcfmMemberLiknkedin = `www.linkedin.com/${faker.word.words(1)}`);
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.youtubeField, VendorRegistrationForm.wcfmMemberYoutube = `www.youtube.com/${faker.word.words(1)}`);
        await this.validateAndFillStrings(Selectors.vendorRegistrationForms.wcfmMember.frontendForm.instagramField, VendorRegistrationForm.wcfmMemberInstagram = `www.instagram.com/${faker.word.words(1)}`);
