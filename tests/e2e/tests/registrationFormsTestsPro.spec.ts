 ...
 * @Test0025 : Admin is checking Registration Forms - Pro Feature Page
 * @Test0026 : Admin is creating Registration Forms - using shortcode
 * @Test0027 : User is registering using - Registration Form
 * @Test0028 : Admin is validating - Registered user
 * 
 *  
 */

    test('0025:[Reg-Forms] Here, Admin is checking Registration Forms - Pro Feature Page', async ({ page }) => {
    ...
    test('0026:[Reg-Forms] Here, Admin is creating Registration Forms Page - using shortcode', async ({ page }) => {
        const RegistrationFormsLite = new RegistrationFormsPage(page);
    ...
    test('0027:[Reg-Forms] Here, User is registering using - Registration Form', async ({ page }) => {
    ...
    test('0028:[Reg-Forms] Here, Admin is validating - Registered user', async ({ page }) => {
        const BasicLogin = new BasicLoginPage(page);
        const RegistrationFormsFrontend = new RegistrationFormsFrontendPage(page);
        //Basic Login
        await BasicLogin.basicLoginAndPluginVisit(Users.adminUsername, Users.adminPassword);
