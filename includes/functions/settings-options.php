    ...
    $settings_fields = [
        ...
        'wpuf_profile'          => apply_filters( 'wpuf_options_profile', [
            ...
            [
                ...
                'label'          => __( 'Login Form Layout', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
            ...
            [
                ...
                'label'          => __( 'Form Background Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => 'transparent',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Form Border Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => 'transparent',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Field Border Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#D1D5DB',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Field Background Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => 'transparent',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Label Text Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#333333',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Placeholder Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#9CA3AF',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Input Text Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#111827',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Help Text Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#6B7280',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Button Background Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#3B82F6',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Button Border Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
            [
                ...
                'label'          => __( 'Button Text Color', 'wp-user-frontend' ) . '<span class="pro-icon"> ' . '<img src="' . WPUF_ASSET_URI . '/images/pro-badge.svg" alt="PRO">' . '</span>',
                'type'           => 'color',
                'default'        => '#ffffff',
                'is_pro_preview' => ! wpuf_is_pro_active(),
            ],
