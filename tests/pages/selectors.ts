...
//0001
    login:{
        ...
        wpufPostForm_CheckAddButton: '//a[@id="new-wpuf-post-form"]',
...
//0003
    createPostForm: {
        ...
        customFieldsImageUpload: '//li[@data-form-field="image_upload"]',
            ...
            //prompt1
            prompt1PopUpModalClose: "//button[@class=\"swal2-confirm btn btn-success swal2-styled\" and contains(text(), \"Don't show again\")]",
            //prompt2
            prompt2PopUpModalOk:'//button[@class="swal2-confirm swal2-styled" and contains(text(), "OK")]',
    ...
    frontEndCheckBlankForm: {
        ...
        //Go to FRONT-END
            ...
            clickVisitSite: '//li[@id="wp-admin-bar-view-site"]//a[1]',
                ...
                //FRONT-END
                frontEndclickPostFormPage: '//a[contains(text(), "Post Form Page")]',
                    ...
                    frontEndClickHomePage: '//a[contains(text(), "Home")]',
