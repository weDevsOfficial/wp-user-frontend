<div class="wpuf-bg-white">
    <div class="wpuf-px-6 wpuf-py-24 sm:wpuf-px-6 sm:wpuf-py-32 lg:wpuf-px-8">
        <div class="wpuf-mx-auto wpuf-w-2/3 wpuf-text-center">
            ...
            <p class="wpuf-mx-auto wpuf-mt-6 wpuf-text-pretty wpuf-text-lg wpuf-text-gray-600">We've introduced important updates to our form builder, which now requires WP User Frontend PRO version 4.1.0 or later
