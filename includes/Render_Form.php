...
class Render_Form {
    ...
    public function render_form( $form_id, $post_id = null ) {
        ...
        if ( !is_user_logged_in() && wpuf_is_checkbox_or_toggle_on( $form_settings['guest_post'] ) ) {
        ...
        if ( $form_vars ) {
            ...
            if ( !is_user_logged_in() && wpuf_is_checkbox_or_toggle_on( $form_settings['guest_post'] ) && wpuf_is_checkbox_or_toggle_on( $form_settings['guest_details'] ) ) {
