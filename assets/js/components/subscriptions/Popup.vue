...
<template>
    <div class="wpuf-relative wpuf-z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="wpuf-fixed wpuf-inset-0 wpuf-z-10 wpuf-w-screen wpuf-overflow-y-auto">
            <div class="wpuf-flex wpuf-min-h-full wpuf-items-end wpuf-justify-center wpuf-p-4 wpuf-text-center wpuf-items-center wpuf-p-0">
                <div class="wpuf-relative wpuf-transform wpuf-overflow-hidden wpuf-rounded-lg wpuf-bg-white wpuf-px-4 wpuf-pb-4 wpuf-pt-5 wpuf-text-left wpuf-shadow-xl wpuf-transition-all wpuf-my-8 wpuf-w-full wpuf-max-w-lg wpuf-p-6">
                    <div class="wpuf-absolute wpuf-right-0 wpuf-top-0 wpuf-hidden wpuf-pr-4 wpuf-pt-4 wpuf-block">
                    ...
                    <div class="wpuf-flex wpuf-items-start">
                        <div class="wpuf-mt-3 wpuf-text-center wpuf-ml-4 wpuf-mt-0 wpuf-text-left">
                    ...
                    <div class="wpuf-mt-5 wpuf-mt-4 wpuf-flex wpuf-flex-row-reverse">
                        <button
                            type="button"
                            @click="$emit('delete')"
                            class="wpuf-inline-flex wpuf-w-full wpuf-justify-center wpuf-rounded-md wpuf-bg-red-600 wpuf-px-3 wpuf-py-2 wpuf-text-sm wpuf-font-semibold wpuf-text-white wpuf-shadow-sm hover:wpuf-bg-red-500 wpuf-ml-3 wpuf-w-auto">
                            {{ __( 'Delete', 'wp-user-frontend' ) }}</button>
                        <button
                            type="button"
                            @click="$emit('hidePopup')"
                            class="wpuf-mt-3 wpuf-inline-flex wpuf-w-full wpuf-justify-center wpuf-rounded-md wpuf-bg-white wpuf-px-3 wpuf-py-2 wpuf-text-sm wpuf-font-semibold wpuf-text-gray-900 wpuf-shadow-sm wpuf-ring-1 wpuf-ring-inset wpuf-ring-gray-300 hover:wpuf-bg-gray-50 wpuf-mt-0 wpuf-w-auto">
