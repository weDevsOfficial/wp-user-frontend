...
class Assets {
    ...
    /**
     * Register assets for Gutenberg blocks. Uses asset manifests generated by the block build
     * process so dependencies and versions stay in sync with the compiled output.
     *
     * @since WPUF_SINCE
     *
     * @return void
