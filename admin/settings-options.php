...
function wpuf_settings_fields() {
    ...
    $settings_fields = array(
        ...
        'wpuf_mails' => apply_filters( 'wpuf_mail_options', array(
            array(
                'name'    => 'email_setting',
                'label'   => __( '<span class="dashicons dashicons-admin-generic"></span> Settings', 'wpuf' ),
                'type'    => 'html',
                'class'   => 'email-setting',
            ),
            array(
                'name'    => 'email_type',
                'label'   => __( 'Email Type', 'wpuf' ),
                'type'    => 'select',
            ...
            array(
                'name'    => 'from_name',
                'label'   => __( '"From" name', 'wpuf' ),
                'desc'    => __( 'How the sender name appears in outgoing WPUF emails.', 'wpuf' ),
            ...
            array(
                'name'    => 'from_address',
                'label'   => __( '"From" address', 'wpuf' ),
                'desc'    => __( 'How the sender email appears in outgoing WPUF emails.', 'wpuf' ),
            ...
            array(
                'name'    => 'header_image',
                'label'   => __( 'Header Image', 'wpuf' ),
                'desc'    => __( 'URL to an image you want to show in the email header. Upload images using the media uploader (Admin > Media). Image size should be 100px width & 100px height.', 'wpuf' ),
                'default' => 'https://wedevs.com/wp-content/uploads/2018/01/email-icon-wpuf-newsletter.png',
                'type'    => 'file',
                'class'   => 'email-setting-option',
            ),
            array(
                'name'    => 'footer_text',
                'label'   => __( 'Footer Text', 'wpuf' ),
                'desc'    => __( 'The text to appear in the footer of WPUF emails. Size should be 100px width & 100px height.', 'wpuf' ),
                'default' => 'Powered by <a href="https://wordpress.org/plugins/wp-user-frontend/">WP User Frontend</a>',
                'type'    => 'textarea',
                'class'   => 'email-setting-option',
            ),
            array(
                'name'    => 'base_color',
                'label'   => __( 'Base Color', 'wpuf' ),
                'desc'    => __( 'The base color for WPUF email templates.', 'wpuf' ),
                'default' => '#00E585',
                'type'    => 'color',
                'class'   => 'email-setting-option',
            ),
            array(
                ...
                'label'   => __( 'Background color', 'wpuf' ),
            ...
            array(
                ...
                'label'   => __( 'Body Background color', 'wpuf' ),
                'desc'    => __( 'The main body background color.', 'wpuf' ),
                'default' => '#fff',
                'type'    => 'color',
                'class'   => 'email-setting-option',
            ),
            array(
                ...
                'label'   => __( 'Body text color', 'wpuf' ),
                'desc'    => __( 'The main body text color.', 'wpuf' ),
                'default' => '#000000',
                'type'    => 'color',
                'class'   => 'email-setting-option',
            ),
            ...
            array(
                ...
                'label'   => __( '<span class="dashicons dashicons-unlock"></span> Reset Email', 'wpuf' ),
                'type'    => 'html',
                'class'   => 'reset-email-setting',
            ),
            array(
                'name'    => 'reset_email_subject',
                'label'   => __( 'Password reset request mail subject', 'wpuf' ),
                'desc'    => __( 'Subject for the email when any user on your website changes the password, the user will get password reset request notification email', 'wpuf' ),
            ...
            array(
                ...
                'label'   => __( 'Password reset request mail body', 'wpuf' ),
                'desc'    => __( "Content for the email when any user on your website changes the password, the user will get password reset request notification email <br><strong>You may use: </strong><code>{username}</code><code>{blogname}</code><code>{password_reset_link}</code>", 'wpuf' ),
                'default' => "Hello! <br><br>You asked us to reset your password for your account. <br><br>To reset your password, visit the following address: <br>{password_reset_link} <br><br>Thanks!",
                'type'    => 'wysiwyg',
                'class'   => 'reset-email-setting-option',
            ),
            array(
                'name'    => 'confirmation_email_setting',
                'label'   => __( '<span class="dashicons dashicons-email-alt"></span> Confirmation Email', 'wpuf' ),
                'type'    => 'html',
                'class'   => 'confirmation-email-setting',
            ),
            array(
                'name'    => 'confirmation_mail_subject',
                'label'   => __( 'Confirmation mail subject', 'wpuf' ),
                'desc'    => __( 'Subject for the confirmation email', 'wpuf' ),
            ...
            array(
                ...
                'label'   => __( 'Confirmation mail body', 'wpuf' ),
                'desc'    => __( "Content for the confirmation email <br><strong>You may use: </strong><code>{username}</code><code>{blogname}</code><code>{activation_link}</code>", 'wpuf' ),
