...
<template>
    <div class="wpuf-pro-field-tooltip" style="left: 50%; top: -0.5em;">
        <h3 class="tooltip-header">{{ __( 'Available in Pro. Also enjoy:', 'wp-user-frontend' ) }}</h3>
        <ul>
            <li class="wpuf-flex wpuf-items-center">
                ...
                </span> {{ __( '24/7 Priority Support', 'wp-user-frontend' ) }}
            </li>
            <li class="wpuf-flex wpuf-items-center">
                <span class="tooltip-check">
                <svg width="10" height="8"
                    ...
                    </span> {{ __( '20+ Premium Modules', 'wp-user-frontend' ) }}
            </li>
            <li class="wpuf-flex wpuf-items-center">
                <span class="tooltip-check">
                <svg width="10" height="8"
                    ...
                    </span> {{ __( 'User Activity and Reports', 'wp-user-frontend' ) }}
            </li>
            <li class="wpuf-flex wpuf-items-center">
                <span class="tooltip-check">
                <svg width="10" height="8"
                    ...
                    </span> {{ __( 'Private Messaging Option', 'wp-user-frontend' ) }}
            </li>
            <li class="wpuf-flex wpuf-items-center">
                <span class="tooltip-check">
                <svg width="10" height="8"
                    ...
                    </span> {{ __( 'License for 20 websites', 'wp-user-frontend' ) }}
            </li>
        </ul>
        <div class="pro-link">
            <a
            ...
            target="_blank"
            class="wpuf-button button-upgrade-to-pro wpuf-flex wpuf-items-center wpuf-w-[calc(100%-2rem)] wpuf-justify-around">{{
                __( 'Upgrade to PRO', 'wp-user-frontend' )
            }}<span
                class="pro-icon icon-white">
