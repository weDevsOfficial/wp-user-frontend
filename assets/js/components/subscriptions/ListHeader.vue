    ...
    <div class="wpuf-flex wpuf-justify-between">
        ...
        <div>
            <button
                ...
                type="button"
                class="wpuf-flex wpuf-items-center wpuf-ml-12 wpuf-rounded-md wpuf-bg-indigo-600 hover:wpuf-bg-indigo-500 wpuf-px-3 wpuf-py-2 wpuf-text-sm wpuf-font-semibold wpuf-text-white wpuf-shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    <span>
